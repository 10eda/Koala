...
public class Graph {
	...
	public void postprocess() {
		...
		bundleList = new BundleList(this, mesh);
		postBundleEv();
	...
	public double PostVertexEv_new(int num){
		...
		for(int i=1;i<bundles.size();i++){
			...
			//connectingとconnectedのどっちかがb1b2の両方に揃ってなかったら何もしない
			...
			//両方双方向の場合の特別処理
			//b1とb2のどっちかのingとedのどっちかだけが合流してたらそっちに合わせる
