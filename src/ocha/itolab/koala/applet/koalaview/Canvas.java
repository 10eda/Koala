...
public class Canvas extends JPanel {
   ...
   public void setDrawer(Drawer d) {
	...
	public void setConfluenceDensityThreshold(double ratio) {
		drawer.setConfluenceThreshold(ratio);
	}
	...
	public void setRotationStrength(double ratio) {
		drawer.setRotationStrength(ratio);
	}
	

	public void setMergeStrength(double ratio) {
		drawer.setMergeStrength(ratio);
	}
